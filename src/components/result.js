...
const Result = () => {
    const { showResult, quizs, marks, startOver }  = useContext(dataQuiz);
    return (
        <section  className=" text-white" style={{ backgroundColor:' rgb(7, 7, 101)', display: `${showResult ? 'block' : 'none'}` }}>
